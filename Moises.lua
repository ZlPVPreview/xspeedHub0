...
discordLabel.Text = "discord.gg/UgaPbYrZNr"
...
currentColorTheme = COLOR_THEMES[data.themeColor] and data.themeColor or "Blue"
...
currentColorTheme = "Blue"; selectedColor = COLOR_THEMES["Blue"]
...
scriptLogo.Image = "rbxassetid://110541283436469"
...
pbFrame.Position = UDim2.new(0.5, -160, 0.80, 0)
pbFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 16)
...
pbOuterStroke.Thickness = 1.5
pbOuterStroke.Transparency = 0.6
progressPct = Instance.new("TextLabel", pbFrame)
progressPct.BackgroundTransparency = 1
progressPct.Position = UDim2.fromOffset(16, 6)
progressPct.Size = UDim2.fromOffset(120, 32)
progressPct.Font = Enum.Font.GothamBlack
progressPct.TextSize = 22
...
fpsNeon.Position = UDim2.new(1, -14, 0, 10)
fpsNeon.Size = UDim2.fromOffset(130, 15)
...
fpsNeon.Text = "-- FPS"
fpsNeon.ZIndex = 505
local pingNeon = Instance.new("TextLabel", pbFrame)
pingNeon.Name = "PingNeon"
pingNeon.BackgroundTransparency = 1
pingNeon.AnchorPoint = Vector2.new(1, 0)
pingNeon.Position = UDim2.new(1, -14, 0, 28)
pingNeon.Size = UDim2.fromOffset(130, 15)
pingNeon.Font = Enum.Font.GothamBold
pingNeon.TextSize = 12
pingNeon.TextColor3 = getThemeColor()
pingNeon.TextXAlignment = Enum.TextXAlignment.Right
pingNeon.Text = "-- MS"
pingNeon.ZIndex = 505
local track = Instance.new("Frame", pbFrame)
track.AnchorPoint = Vector2.new(0.5, 1)
track.Position = UDim2.new(0.5, 0, 1, -9)
track.Size = UDim2.new(0.9, 0, 0, 6)
track.BackgroundColor3 = Color3.fromRGB(6, 6, 10)
...
local fillLayer = Instance.new("Frame", progressFill)
fillLayer.Size = UDim2.new(1, 0, 1, 0)
fillLayer.BackgroundColor3 = getThemeColor()
fillLayer.BorderSizePixel = 0
fillLayer.ZIndex = 503
Instance.new("UICorner", fillLayer).CornerRadius = UDim.new(1, 0)
local tracedGrad = Instance.new("UIGradient", fillLayer)
tracedGrad.Name = "TracedGrad"
local accentCol = getThemeColor()
tracedGrad.Color = ColorSequence.new({
ColorSequenceKeypoint.new(0.0, accentCol),
ColorSequenceKeypoint.new(0.3, accentCol),
ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 255, 255)),
ColorSequenceKeypoint.new(0.7, accentCol),
ColorSequenceKeypoint.new(1.0, accentCol),
})
tracedGrad.Rotation = 0
for _ = 1, 28 do
local star = Instance.new("Frame", pbFrame)
...
for _ = 1, 14 do
local money = Instance.new("TextLabel", pbFrame)
money.BackgroundTransparency = 1
money.Size = UDim2.fromOffset(10, 10)
money.Position = UDim2.fromScale(math.random(), math.random() * 0.65)
money.Text = "$"
money.TextColor3 = Color3.fromRGB(255, 255, 255)
money.TextTransparency = math.random(7, 9) / 10
money.TextSize = math.random(8, 12)
money.Rotation = math.random(-45, 45)
money.Font = Enum.Font.GothamBold
money.ZIndex = 501
end
task.spawn(function()
while tracedGrad and tracedGrad.Parent do
local fw = TS:Create(tracedGrad, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), { Offset = Vector2.new(0.5, 0) })
fw:Play(); fw.Completed:Wait()
if not (tracedGrad and tracedGrad.Parent) then break end
local bk = TS:Create(tracedGrad, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), { Offset = Vector2.new(-0.5, 0) })
bk:Play(); bk.Completed:Wait()
end
end)
task.spawn(function()
